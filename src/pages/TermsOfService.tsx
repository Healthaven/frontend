...
const TermsOfService = () => {
  return (
    <LegalLayout title="Terms of Service" lastUpdated="January 11, 2026">
      <section>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">7. Health Information Accuracy</h2>
        <div className="text-muted-foreground">
          <p>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">8. Third-Party Services and Links</h2>
        <div className="text-muted-foreground">
          <p>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">11. Disclaimers and Limitations of Liability</h2>
        <div className="text-muted-foreground space-y-4">
          <div>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">13. Modifications to Services and Terms</h2>
        <div className="text-muted-foreground">
          <p>
