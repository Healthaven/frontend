...
const PrivacyPolicy = () => {
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="January 11, 2026">
      <section>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">5. Your Privacy Rights and Choices</h2>
        <div className="text-muted-foreground space-y-4">
          <div>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">10. Third-Party Links and Services</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">11. Health Information and HIPAA</h2>
        <div className="text-muted-foreground space-y-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">13. Nigeria Data Protection Rights (NDPA)</h2>
        <div className="text-muted-foreground space-y-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-4">15. Changes to This Privacy Policy</h2>
        <div className="text-muted-foreground space-y-4">
